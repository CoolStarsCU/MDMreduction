...
def main(ref_sky, input_file='to_shift.lis', output_file='OI_shifts.tbl'):
    '''
    Cross-correlates sky spectra of objects in input_file list against a chosen reference sky spectrum ref_sky (ccd.###), which it usually is a long exposure one. Output file has the wavelength shift, 1-sigma error, and quality factor for each case.
    '''
